...
public final class Intents {
  ...
  public static final class Scan {
    /**
     * Send this intent to open the Barcodes icon_camera in scanning mode, find a barcode, and return
     * the results.
     */
     ...
     * The icon_camera will try to honor these, but will clamp them to the size of the preview frame.
     ...
     * of the icon_camera which requested the scan via
