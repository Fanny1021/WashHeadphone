...
/**
 * A base class for the Android-specific barcode handlers. These allow the icon_camera to polymorphically
...
public abstract class ResultHandler {
  ...
  private void sendSMSFromUri(String uri, String body) {
    ...
    // Exit the icon_camera once the SMS is sent
  ...
  private void sendMMSFromUri(String uri, String subject, String body) {
    Intent intent = new Intent(Intent.ACTION_SENDTO, Uri.parse(uri));
    // The Messaging icon_camera needs to see a valid subject or else it will treat this an an SMS.
